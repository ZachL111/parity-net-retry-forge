...
parity-net-retry-forge is a TypeScript project for networking. It focuses on this technical goal: Design a TypeScript verification harness for retry systems, covering simulation kernel, seeded input scenarios, and failure-oriented tests.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 170, risk penalty 4, latency penalty 4, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
