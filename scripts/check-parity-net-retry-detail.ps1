...
$repo = "parity-net-retry-forge"
$language = "TypeScript"
$category = "Networking"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/parity-net-retry-walkthrough.md")) {
