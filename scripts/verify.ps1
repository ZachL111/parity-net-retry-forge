...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-parity-net-retry-detail.ps1

node dist/tests/domainReview.test.js

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-parity-net-retry-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-parity-net-retry-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-parity_net_retry_forge-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
