"""Regression checks for the parity-net-retry-forge casebook."""
...
from casebook.harness import assert_expected, parity_net_retry_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(parity_net_retry_forge_summary(), assert_expected())
